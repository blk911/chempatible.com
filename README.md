...
4. Answer the first five as the prospect, add their picture, then compare compact side-by-side answers. Matching choices are green; different choices are grey. Send a first-name and cell connection request.
